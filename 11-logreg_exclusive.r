...
N_by_group_all <-table(alldata$mooddisorder)
...
N_by_group_complete_cases <- table(alldata$mooddisorder)
...
n_by_group <- rbind(N_by_group_all, N_by_group_complete_cases)

write.csv(output, "logreg_exclusive.csv")
write.csv(n_by_group, "N_by_group_excusive.csv")
